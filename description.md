...
```json
    ...
    "penalty": "l2"
```
А для модели с кросс-валидацией с помощью `GridSearchCV` были выбраны следующие параметры:
```json
    "alpha": 0.001,
    "class_weight": "balanced",
    "max_iter": 800,
